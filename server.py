...
emotion detection function using the EmotionDetection package,
...
def emot_detector():
    ...
    runs emotion detection, and returns a formatted response.
    Handles blank/invalid input with an error message.
    """
